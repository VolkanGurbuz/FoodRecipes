...
public class HorizontalDottedProgress extends View {
  ...
  private void createDot(Canvas canvas, Paint paint) {
    ...
    // here i have setted progress bar with 10 dots , so repeat and wnen i = mDotPosition  then
    ...
    bounceAnimation.setAnimationListener(
        new Animation.AnimationListener() {
          ...
          public void onAnimationRepeat(Animation animation) {
            mDotPosition++;
            // when mDotPosition == mDotAmount , then start again applying animation from 0th
            // positon , i.e  mDotPosition = 0;
